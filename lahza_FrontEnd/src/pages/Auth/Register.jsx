...
//     return null;
//   }
//   // This function receives the form data from handleSubmit
//   const OnSubmit = async (data) => {
//     setSubmitting(true);
//     console.log("team register data submitted", data);
...
//       if (!token) {
//         console.error(
//           "❌ No CSRF token found! Check your Laravel CORS config."
//         );
//         return;
//       }
//       // 2️⃣ S
